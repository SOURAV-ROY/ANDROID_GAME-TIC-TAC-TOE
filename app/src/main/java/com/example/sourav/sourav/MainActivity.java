package com.example.sourav.sourav;
...
//        });
            ...
            b = (Button) findViewById(R.id.game);
            sou= (Button) findViewById(R.id.btn_SOURAV);

            sou.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Toast.makeText(getApplicationContext(),"SOURAV ROY", Toast.LENGTH_SHORT).show();
                    Intent s = new Intent(MainActivity.this, SouravDetails.class);
                    startActivity(s);
                }
            });
